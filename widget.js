...
requirejs.config({
    paths: {
        ...
        Three: 'jslib/threejs/build/three',
        ThreeTextGeometry: 'jslib/threejs/src/extras/geometries/TextGeometry',
        ThreeFontUtils: 'jslib/cplibs/FontUtils',
        ThreeDetector: 'jslib/threejs/examples/js/Detector',
        ThreeTrackballControls: 'jslib/threejs/examples/js/controls/TrackballControls',
        ThreeOrbitControls: 'jslib/threejs/examples/js/controls/OrbitControls',
        ThreeHelvetiker: 'jslib/cplibs/threehelvetiker',
        ThreeTween: 'jslib/cplibs/tween.min',
        ThreeBufferGeometryUtils: 'jslib/cplibs/BufferGeometryUtils',
        ThreeCanvasRenderer: 'jslib/threejs/examples/js/renderers/CanvasRenderer',
        ThreeProjector: 'jslib/threejs/examples/js/renderers/Projector',

        // not found at googlecode
